# No finished, an experiment to install a local download strategy
class MyDownloadStrategy < AbstractFileDownloadStrategy
...
class Dockenvlocal < Formula
  ...
  head "file:///home/admin/code/dockenv", branch: "main", using: MyDownloadStrategy
  ...
  def caveats
    ...
    <<~EOS
      ...
      Scripts can be run directly by name without the .sh extension.
